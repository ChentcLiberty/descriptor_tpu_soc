...
module tb_tpu_stage2_fullcore_wrapper_multi_diag;
    ...
    initial begin
        ...
        $display("[TB] done=%0b error=%0b timeout=%0d out0=%08h out1=%08h in_cnt=%0d param_cnt=%0d",
                 status_done, status_error, timeout_count,
                 mem[(OUTPUT_BASE >> 2) & 32'h3ff],
                 mem[((OUTPUT_BASE + 32'd4) >> 2) & 32'h3ff],
                 input_fetch_word_count_reg, param_fetch_word_count_reg);
        $display("[TB] expected out0=04001e00 out1=01000280");
        ...
        if(mem[(OUTPUT_BASE >> 2) & 32'h3ff] != 32'h0400_1e00) begin
            $display("[TB][FAIL] out0 mismatch: got %08h expected 04001e00", mem[(OUTPUT_BASE >> 2) & 32'h3ff]);
            $finish;
        end
        if(mem[((OUTPUT_BASE + 32'd4) >> 2) & 32'h3ff] != 32'h0100_0280) begin
            $display("[TB][FAIL] out1 mismatch: got %08h expected 01000280", mem[((OUTPUT_BASE + 32'd4) >> 2) & 32'h3ff]);
            $finish;
        end

        $display("[TB] output_mem[0]=%08h output_mem[1]=%08h", mem[(OUTPUT_BASE >> 2) & 32'h3ff], mem[((OUTPUT_BASE + 32'd4) >> 2) & 32'h3ff]);
        $display("[TB] final ub[6]=%04h ub[7]=%04h ub[8]=%04h ub[9]=%04h",
                 dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_memory[6],
                 dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_memory[7],
                 dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_memory[8],
                 dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_memory[9]);
        $display("[TB][PASS] multi-input fullcore regression completed");
        $finish;
    end
    ...
    always @(posedge clk) begin
        if(!rst_n) begin
            ...
            if(status_busy && (dut.bridge_u.tile_word_idx_reg == 32'd1) && !tile1_banner_printed) begin
                tile1_banner_printed <= 1'b1;
                $display("[TRACE] enter tile1 t=%0t out_idx=%0d state=%0d prev_cap=%04h/%04h current_bias=%08h ub6=%04h ub7=%04h",
                         $time,
                         dut.bridge_u.output_word_idx_reg,
                         dut.bridge_u.state_reg,
                         dut.bridge_u.captured_out0_reg,
                         dut.bridge_u.captured_out1_reg,
            ...
            if(status_busy &&
               ...
               (dut.sys_valid_out_21 ||
                ...
                dut.vpu_valid_out_1 ||
                dut.vpu_valid_out_2 ||
                (dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_rd_bias_data_out_0 != 16'd0) ||
                (dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_rd_bias_data_out_1 != 16'd0) ||
                dut.fullcore_tpu_soc_u.tpu_inst.vpu_inst.bias_valid_1_out ||
                dut.fullcore_tpu_soc_u.tpu_inst.vpu_inst.bias_valid_2_out)) begin
                $display("[TRACE] t=%0t st=%0d out_idx=%0d tile=%0d core_rst=%0b bias_rd=%04h/%04h sys=%0b:%04h %0b:%04h bias_z=%0b:%04h %0b:%04h vpu=%0b:%04h %0b:%04h",
                         $time,
                         dut.bridge_u.state_reg,
                         dut.bridge_u.output_word_idx_reg,
                         dut.bridge_u.tile_word_idx_reg,
                         dut.core_reset_req,
                         dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_rd_bias_data_out_0,
                         dut.fullcore_tpu_soc_u.tpu_inst.ub_inst.ub_rd_bias_data_out_1,
                         dut.sys_valid_out_21,
                         dut.sys_data_out_21,
                         dut.sys_valid_out_22,
                         dut.sys_data_out_22,
                         dut.fullcore_tpu_soc_u.tpu_inst.vpu_inst.bias_valid_1_out,
                         dut.fullcore_tpu_soc_u.tpu_inst.vpu_inst.bias_z_data_out_1,
                         dut.fullcore_tpu_soc_u.tpu_inst.vpu_inst.bias_valid_2_out,
                         dut.fullcore_tpu_soc_u.tpu_inst.vpu_inst.bias_z_data_out_2,
                         dut.vpu_valid_out_1,
                         dut.vpu_data_out_1,
                         dut.vpu_valid_out_2,
                         dut.vpu_data_out_2);
