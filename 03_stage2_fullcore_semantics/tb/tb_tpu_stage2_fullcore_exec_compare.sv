...
module tb_tpu_stage2_fullcore_exec_compare;
    ...
    localparam [31:0] TPU_DESC_F_TRANSITION_MSE = 32'h0200_0000;
    ...
    task automatic load_case_single_tile_no_relu;
        begin
            ...
            case_expected_mem[0] = 32'hff00_0240;
            case_expected_mem[1] = 32'hfe80_0200;
        end
    endtask
    ...
    task automatic load_case_multi_tile_no_relu;
        begin
            ...
            case_expected_mem[0] = 32'hff80_0400;
            case_expected_mem[1] = 32'h0100_fb00;
        end
    endtask
    ...
    task automatic load_case_multi_tile_relu;
        begin
            clear_case_storage();
            case_net_id = 32'd2;
            case_flags = TPU_DESC_F_TILE2X2_Q8_8 | TPU_DESC_F_RELU;
            case_input_words = 32'd2;
            case_output_words = 32'd2;
            case_param_count = 10;
            ...
            case_expected_mem[0] = 32'h0000_0200;
            case_expected_mem[1] = 32'h0000_0400;
        end
    endtask


    task automatic load_case_single_tile_transition_relu;
        begin
            clear_case_storage();
            case_net_id = 32'd3;
            case_flags = TPU_DESC_F_TILE2X2_Q8_8 | TPU_DESC_F_RELU | TPU_DESC_F_TRANSITION_MSE;
            case_input_words = 32'd1;
            case_output_words = 32'd2;
            case_param_count = 6;
            case_scratch_count = 2;
            ...
            case_scratch_mem[0] = 32'h0080_0100;
            case_scratch_mem[1] = 32'h0080_0100;

            case_expected_mem[0] = 32'hff80_0140;
            case_expected_mem[1] = 32'hff80_0100;
        end
    endtask

    task automatic load_case_multi_tile_transition_relu;
        begin
            clear_case_storage();
            case_net_id = 32'd4;
            case_flags = TPU_DESC_F_TILE2X2_Q8_8 | TPU_DESC_F_RELU | TPU_DESC_F_TRANSITION_MSE;
            ...
            case_expected_mem[0] = 32'hff80_0100;
            case_expected_mem[1] = 32'hff80_0300;
        end
    endtask
    ...
    task automatic program_case_to_memory;
        ...
        begin
            ...
            for(idx = 0; idx < case_scratch_count; idx = idx + 1) begin
                mem[((case_scratch_addr + (idx << 2)) >> 2) & 32'h3ff] = case_scratch_mem[idx];
            end
        end
    endtask
    ...
    initial begin
        ...
        load_case_single_tile_transition_relu();
        run_case("single_tile_transition_relu");

        load_case_multi_tile_transition_relu();
        run_case("multi_tile_transition_relu");

        if(err_count == 0) begin
            $display("[PASS] tb_tpu_stage2_fullcore_exec_compare complete");
        end else begin
            $display("[FAIL] tb_tpu_stage2_fullcore_exec_compare err_count=%0d", err_count);
        end
        $finish;
    end
