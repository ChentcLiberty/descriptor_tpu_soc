...
module tpu #(
    ...
    parameter int SYS_PSUM_WIDTH = 48
)(
    input logic clk,
    input logic rst,
    ...
    output logic signed [SYS_PSUM_WIDTH-1:0] sys_psum_out_21,
    output logic signed [SYS_PSUM_WIDTH-1:0] sys_psum_out_22,
