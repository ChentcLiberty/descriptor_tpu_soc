...
module tb_panda_soc_stage2_cpu_boot_cpu_frontend_raw;
    ...
    localparam [31:0] EXPECT_CLASSIFIER_L2_OUT0  = `BREATH_CPU_FRONTEND_Q8_8_EXPECT_CLASSIFIER_L2_OUT0;
    localparam [31:0] EXPECT_CLASSIFIER_L2_OUT31 = `BREATH_CPU_FRONTEND_Q8_8_EXPECT_CLASSIFIER_L2_OUT31;
    localparam [31:0] EXPECT_CLASSIFIER_OUT0     = `BREATH_CPU_FRONTEND_Q8_8_EXPECT_CLASSIFIER_OUT0;
    localparam [31:0] EXPECT_CLASSIFIER_OUT1     = `BREATH_CPU_FRONTEND_Q8_8_EXPECT_CLASSIFIER_OUT1;
    ...
    localparam [31:0] FRONTEND_CNN_READY_ADDR = 32'h1000_0110;
    localparam [31:0] FRONTEND_PREPROCESS_READY_ADDR = 32'h1000_0114;
    ...
    localparam IMEM_INIT_FILE    = "/home/jjt/soc/my_soc/CPU_Copetition_tpu_soc/work/600_competition_5stage/fpga/stage2_programs/breath_tpu_soc_demo_cpu_frontend/breath_tpu_soc_demo_cpu_frontend_imem.txt";
    localparam IMEM_INIT_FILE_B0 = "/home/jjt/soc/my_soc/CPU_Copetition_tpu_soc/work/600_competition_5stage/fpga/stage2_programs/breath_tpu_soc_demo_cpu_frontend/breath_tpu_soc_demo_cpu_frontend_imem_b0.txt";
    localparam IMEM_INIT_FILE_B1 = "/home/jjt/soc/my_soc/CPU_Copetition_tpu_soc/work/600_competition_5stage/fpga/stage2_programs/breath_tpu_soc_demo_cpu_frontend/breath_tpu_soc_demo_cpu_frontend_imem_b1.txt";
    localparam IMEM_INIT_FILE_B2 = "/home/jjt/soc/my_soc/CPU_Copetition_tpu_soc/work/600_competition_5stage/fpga/stage2_programs/breath_tpu_soc_demo_cpu_frontend/breath_tpu_soc_demo_cpu_frontend_imem_b2.txt";
    localparam IMEM_INIT_FILE_B3 = "/home/jjt/soc/my_soc/CPU_Copetition_tpu_soc/work/600_competition_5stage/fpga/stage2_programs/breath_tpu_soc_demo_cpu_frontend/breath_tpu_soc_demo_cpu_frontend_imem_b3.txt";
    ...
    initial begin
        ...
        $display("[TB] raw CPU-front-end shared SRAM supplied through shared_sram_init_file: %0s", PARAM_POOL_INIT_FILE);
        ...
        $display("[TB] cpu boot launched all twenty-one stages with raw CPU-front-end q8.8 path");
        $display("[TB] CPU top-level stage2 raw CPU-front-end boot test passed");
        repeat(20) @(posedge clk);
        $finish;
    end
