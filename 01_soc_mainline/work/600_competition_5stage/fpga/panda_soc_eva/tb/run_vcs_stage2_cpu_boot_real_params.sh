...
BUILD_DIR="$SCRIPT_DIR/sim_build_vcs_stage2_cpu_boot_real_params"
RTL_DIR="$SOC_DIR/rtl"
...
vlogan -full64 -sverilog \
  ...
  "$SCRIPT_DIR/tb_panda_soc_stage2_cpu_boot_real_params.sv"

vcs -full64 tb_panda_soc_stage2_cpu_boot_real_params -o simv_stage2_cpu_boot_real_params
./simv_stage2_cpu_boot_real_params
