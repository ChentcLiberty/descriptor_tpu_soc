...
BUILD_DIR="$SCRIPT_DIR/sim_build_vcs_stage2_cpu_boot_real_params_diag"
RTL_DIR="$SOC_DIR/rtl"
...
vlogan -full64 -sverilog \
  ...
  "$SCRIPT_DIR/tb_panda_soc_stage2_cpu_boot_real_params_diag.sv"

vcs -full64 tb_panda_soc_stage2_cpu_boot_real_params_diag -o simv_stage2_cpu_boot_real_params_diag
./simv_stage2_cpu_boot_real_params_diag
