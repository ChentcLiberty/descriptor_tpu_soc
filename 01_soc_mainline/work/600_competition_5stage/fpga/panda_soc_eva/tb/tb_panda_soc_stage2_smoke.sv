...
module tb_panda_soc_stage2_smoke;
    ...
    task mmio_read;
        ...
        begin
            ...
            if(!sim_tpu_ctrl_axil_rvalid) begin
                $display("[TB][DBG] read timeout sys_resetn=%0b sim_arvalid=%0b sim_arready=%0b sim_rvalid=%0b sim_rready=%0b top_arvalid=%0b top_arready=%0b top_rvalid=%0b top_rready=%0b regs_arvalid=%0b regs_arready=%0b regs_rvalid=%0b regs_rready=%0b regs_rdata=%08x",
                    dut.sys_resetn,
