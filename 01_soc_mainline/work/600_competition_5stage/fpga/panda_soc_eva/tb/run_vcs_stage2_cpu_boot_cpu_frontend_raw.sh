...
echo "[SOAK] stage2_cpu_boot_cpu_frontend_raw: this is a long-running raw CPU-front-end soak test."
echo "[SOAK] It runs raw preprocessing + CPU CNN/FiLM before TPU classifier launches and is intentionally not part of the stable suite."
...
vlogan -full64 -sverilog \
  ...
  "$SCRIPT_DIR/tb_panda_soc_stage2_cpu_boot_cpu_frontend_raw.sv"

vcs -full64 tb_panda_soc_stage2_cpu_boot_cpu_frontend_raw -o simv_stage2_cpu_boot_cpu_frontend_raw
