...
module tb_panda_soc_stage2_cpu_boot;
    ...
    localparam [31:0] EXPECT_MLP_KEY_OUT0  = 32'h0200_0100;
    localparam [31:0] EXPECT_MLP_KEY_OUT15 = 32'h2000_1000;
    localparam [31:0] EXPECT_MLP_KEY_OUT31 = 32'h2000_1000;
    localparam [31:0] EXPECT_MLP_KEY_OUT63 = 32'h2000_1000;
    localparam [31:0] EXPECT_MLP_OTHER_OUT0 = 32'h0001_0002;
    localparam [31:0] EXPECT_MLP_OTHER_OUT1 = 32'h0003_0004;
    localparam [31:0] EXPECT_MLP_OTHER_OUT2 = 32'h0005_0006;
    localparam [31:0] EXPECT_CLASSIFIER_OUT0 = 32'h0200_0100;
    localparam [31:0] EXPECT_CLASSIFIER_OUT1 = 32'h0400_0200;
    localparam [31:0] EXPECT_CLASSIFIER_OUT15 = 32'h2000_1000;
    localparam [31:0] EXPECT_CLASSIFIER_OUT31 = 32'h0000_020E;
    localparam [31:0] EXPECT_CLASSIFIER_OUT63 = 32'h0000_022E;
    localparam [31:0] EXPECT_CLASSIFIER_OUT112 = 32'h0000_025F;
    localparam [31:0] EXPECT_CLASSIFIER_OUT127 = 32'h0000_026E;
    ...
    initial begin
        ...
        expect_word(OUT0_WORD_INDEX + 0,  EXPECT_MLP_KEY_OUT0,  "mlp_key l0 output[0] mismatch");
        expect_word(OUT0_WORD_INDEX + 15, EXPECT_MLP_KEY_OUT15, "mlp_key l0 output[15] mismatch");
        expect_launch(3, 32'd0, TPU_DESC0_BASE);
        expect_word(SCRATCH0_WORD_INDEX + 0,  EXPECT_MLP_KEY_OUT0,  "mlp_key l1 output[0] mismatch");
        expect_word(SCRATCH0_WORD_INDEX + 31, EXPECT_MLP_KEY_OUT31, "mlp_key l1 output[31] mismatch");
        expect_launch(4, 32'd0, TPU_DESC1_BASE);
        expect_word(OUT1_WORD_INDEX + 0,  EXPECT_MLP_KEY_OUT0,  "mlp_key l2 output[0] mismatch");
        expect_word(OUT1_WORD_INDEX + 63, EXPECT_MLP_KEY_OUT63, "mlp_key l2 output[63] mismatch");
        expect_launch(5, 32'd0, TPU_DESC0_BASE);
        expect_word(SCRATCH1_WORD_INDEX + 0,  EXPECT_MLP_KEY_OUT0,  "mlp_key l3 output[0] mismatch");
        expect_word(SCRATCH1_WORD_INDEX + 31, EXPECT_MLP_KEY_OUT31, "mlp_key l3 output[31] mismatch");
        expect_launch(6, 32'd1, TPU_DESC1_BASE);
        expect_word(OUT0_WORD_INDEX + 0,  EXPECT_MLP_KEY_OUT0,  "mlp_key l4 output[0] mismatch");
        expect_word(OUT0_WORD_INDEX + 15, EXPECT_MLP_KEY_OUT15, "mlp_key l4 output[15] mismatch");
        expect_launch(7, 32'd1, TPU_DESC0_BASE);
        expect_word(OUT1_WORD_INDEX + 0,  EXPECT_MLP_OTHER_OUT0, "mlp_other l0 output[0] mismatch");
        expect_word(OUT1_WORD_INDEX + 1,  EXPECT_MLP_OTHER_OUT1, "mlp_other l0 output[1] mismatch");
        expect_word(OUT1_WORD_INDEX + 2,  EXPECT_MLP_OTHER_OUT2, "mlp_other l0 output[2] mismatch");
        expect_word(OUT1_WORD_INDEX + 15, EXPECT_MLP_OTHER_OUT0, "mlp_other l0 output[15] mismatch");
        expect_launch(8, 32'd2, TPU_DESC0_BASE);
        expect_word(SCRATCH1_WORD_INDEX + 0,  EXPECT_MLP_OTHER_OUT0, "mlp_other l1 output[0] mismatch");
        expect_word(SCRATCH1_WORD_INDEX + 15, EXPECT_MLP_OTHER_OUT0, "mlp_other l1 output[15] mismatch");
        expect_launch(9, 32'd2, TPU_DESC1_BASE);
        expect_word(CLASS_L0_WORD_INDEX + 0,  EXPECT_CLASSIFIER_OUT0, "classifier l0 chunk0 output[0] mismatch");
        expect_word(CLASS_L0_WORD_INDEX + 15, EXPECT_CLASSIFIER_OUT15, "classifier l0 chunk0 output[15] mismatch");
        ...
        expect_word(CLASS_L0_WORD_INDEX + 112, EXPECT_CLASSIFIER_OUT112, "classifier l0 chunk7 output[112] mismatch");
        expect_word(CLASS_L0_WORD_INDEX + 127, EXPECT_CLASSIFIER_OUT127, "classifier l0 chunk7 output[127] mismatch");
        expect_launch(17, 32'd2, TPU_DESC1_BASE);
        expect_word(CLASS_L1_WORD_INDEX + 0,  EXPECT_CLASSIFIER_OUT0, "classifier l1 chunk0 output[0] mismatch");
        expect_word(CLASS_L1_WORD_INDEX + 15, EXPECT_CLASSIFIER_OUT15, "classifier l1 chunk0 output[15] mismatch");
        expect_launch(18, 32'd2, TPU_DESC0_BASE);
        expect_launch(19, 32'd2, TPU_DESC1_BASE);
        expect_launch(20, 32'd2, TPU_DESC0_BASE);
        expect_word(CLASS_L1_WORD_INDEX + 63, EXPECT_CLASSIFIER_OUT63, "classifier l1 chunk3 output[63] mismatch");
        expect_launch(21, 32'd2, TPU_DESC1_BASE);
        expect_word(CLASS_L2_WORD_INDEX + 0,  EXPECT_CLASSIFIER_OUT0, "classifier l2 output[0] mismatch");
        expect_word(CLASS_L2_WORD_INDEX + 31, EXPECT_CLASSIFIER_OUT31, "classifier l2 output[31] mismatch");
        ...
        expect_word(PARAM_KEY_L1_INDEX + 0, 32'h0000_0100, "param_pool key_l1[0] mismatch");
        expect_word(PARAM_KEY_L1_INDEX + 1, 32'h0100_0000, "param_pool key_l1[1] mismatch");
        expect_word(PARAM_KEY_L2_INDEX + 0, 32'h0000_0100, "param_pool key_l2[0] mismatch");
        expect_word(PARAM_KEY_L2_INDEX + 1, 32'h0100_0000, "param_pool key_l2[1] mismatch");
        expect_word(PARAM_KEY_L3_INDEX + 0, 32'h0000_0100, "param_pool key_l3[0] mismatch");
        expect_word(PARAM_KEY_L3_INDEX + 1, 32'h0100_0000, "param_pool key_l3[1] mismatch");
        expect_word(PARAM_KEY_L4_INDEX + 0, 32'h0000_0100, "param_pool key_l4[0] mismatch");
        expect_word(PARAM_KEY_L4_INDEX + 1, 32'h0100_0000, "param_pool key_l4[1] mismatch");
        expect_word(PARAM_OTHER_INDEX + 0, 32'h0000_0100, "param_pool other[0] mismatch");
        expect_word(PARAM_OTHER_INDEX + 1, 32'h0100_0000, "param_pool other[1] mismatch");
        expect_word(PARAM_OTHER_L1_INDEX + 0, 32'h0000_0100, "param_pool other_l1[0] mismatch");
        expect_word(PARAM_OTHER_L1_INDEX + 1, 32'h0100_0000, "param_pool other_l1[1] mismatch");
        expect_word(PARAM_CLASSIFIER_INDEX + 0, 32'h0000_0100, "param_pool classifier_l0[0] mismatch");
        expect_word(PARAM_CLASSIFIER_INDEX + 1, 32'h0100_0000, "param_pool classifier_l0[1] mismatch");
        expect_word(PARAM_CLASSIFIER_L1_INDEX + 0, 32'h0000_0100, "param_pool classifier_l1[0] mismatch");
        expect_word(PARAM_CLASSIFIER_L1_INDEX + 1, 32'h0100_0000, "param_pool classifier_l1[1] mismatch");
        expect_word(PARAM_CLASSIFIER_L2_INDEX + 0, 32'h0000_0100, "param_pool classifier_l2[0] mismatch");
        expect_word(PARAM_CLASSIFIER_L2_INDEX + 1, 32'h0100_0000, "param_pool classifier_l2[1] mismatch");
        expect_word(PARAM_CLASSIFIER_L3_INDEX + 0, 32'h0000_0100, "param_pool classifier_l3[0] mismatch");
        expect_word(PARAM_CLASSIFIER_L3_INDEX + 1, 32'h0100_0000, "param_pool classifier_l3[1] mismatch");

        expect_word(CLASS_OUT_WORD_INDEX + 0, EXPECT_CLASSIFIER_OUT0, "classifier final output[0] mismatch");
        expect_word(CLASS_OUT_WORD_INDEX + 1, EXPECT_CLASSIFIER_OUT1, "classifier final output[1] mismatch");

        $display("[TB] cpu boot launched all twenty-one stages and shared SRAM contents match expectations");
